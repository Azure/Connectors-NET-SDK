// Office365usersExtensions.cs - Auto-generated DirectClient SDK
...
namespace Microsoft.Azure.Connectors.DirectClient.Office365users;
...
/// <summary>
/// Exception thrown when office365users connector operations fail.
/// </summary>
public class Office365usersConnectorException : Exception
{
    ...
    public Office365usersConnectorException(string operation, int statusCode, string responseBody)
...
/// </summary>
public class Office365usersClient : IDisposable
{
    ...
    public Office365usersClient(string connectionRuntimeUrl, TokenCredential credential = null, HttpClient httpClient = null)
    {
    ...
    /// <param name="httpClient">Optional <see cref="HttpClient"/>. A new one will be created if not provided.</param>
    public Office365usersClient(string connectionRuntimeUrl, string managedIdentityClientId, HttpClient httpClient = null)
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!response.IsSuccessStatusCode)
        {
            ...
            throw new Office365usersConnectorException(operation, (int)response.StatusCode, errorBody);
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            var responseBody = await response.Content.ReadAsStringAsync(cancellationToken);
            throw new Office365usersConnectorException(operation, (int)response.StatusCode, responseBody);
        }
    }
