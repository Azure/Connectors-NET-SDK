...
public class TeamsClient : ConnectorClientBase
{
    ...
    public TeamsClient(string connectionRuntimeUrl, TokenCredential credential = null, ConnectorClientOptions options = null)
    ...
    /// <param name="options">Optional client options for retry, timeout, etc.</param>
    public TeamsClient(string connectionRuntimeUrl, string managedIdentityClientId, ConnectorClientOptions options = null)
