...
public class TeamsClient : ConnectorClientBase
{
    ...
    public TeamsClient(string connectionRuntimeUrl, TokenCredential credential = null, ConnectorClientOptions options = null, HttpClient httpClient = null)
    ...
    /// <param name="options">Optional client options for retry, timeout, etc.</param>
    /// <param name="httpClient">Optional <see cref="HttpClient"/>. A new one will be created if not provided.</param>
    public TeamsClient(string connectionRuntimeUrl, string managedIdentityClientId, ConnectorClientOptions options = null, HttpClient httpClient = null)
