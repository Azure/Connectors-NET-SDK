...
public class AzureblobClient : ConnectorClientBase
{
    ...
    public AzureblobClient(string connectionRuntimeUrl, TokenCredential credential = null, ConnectorClientOptions options = null, HttpClient httpClient = null)
    ...
    /// <param name="options">Optional client options for retry, timeout, etc.</param>
    /// <param name="httpClient">Optional <see cref="HttpClient"/>. A new one will be created if not provided.</param>
    public AzureblobClient(string connectionRuntimeUrl, string managedIdentityClientId, ConnectorClientOptions options = null, HttpClient httpClient = null)
