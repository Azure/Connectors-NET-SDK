// AzureblobExtensions.cs - Auto-generated DirectClient SDK
...
namespace Microsoft.Azure.Connectors.DirectClient.Azureblob;
...
/// <summary>
/// Exception thrown when azureblob connector operations fail.
/// </summary>
public class AzureblobConnectorException : Exception
{
    ...
    public AzureblobConnectorException(string operation, int statusCode, string responseBody)
...
public class AzureblobClient : IDisposable
{
    ...
    public AzureblobClient(string connectionRuntimeUrl, TokenCredential credential = null, HttpClient httpClient = null)
    {
    ...
    /// <param name="httpClient">Optional <see cref="HttpClient"/>. A new one will be created if not provided.</param>
    public AzureblobClient(string connectionRuntimeUrl, string managedIdentityClientId, HttpClient httpClient = null)
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!response.IsSuccessStatusCode)
        {
            ...
            throw new AzureblobConnectorException(operation, (int)response.StatusCode, errorBody);
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            var responseBody = await response.Content.ReadAsStringAsync(cancellationToken);
            throw new AzureblobConnectorException(operation, (int)response.StatusCode, responseBody);
        }
    }
