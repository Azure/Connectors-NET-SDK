// OnedriveforbusinessExtensions.cs - Auto-generated DirectClient SDK
...
namespace Microsoft.Azure.Connectors.DirectClient.Onedriveforbusiness;
...
/// Deserialize AI Gateway callbacks directly: <c>JsonSerializer.Deserialize&lt;OnedriveforbusinessOnNewFilesTriggerPayload&gt;(body)</c>.
/// </summary>
...
/// Deserialize AI Gateway callbacks directly: <c>JsonSerializer.Deserialize&lt;OnedriveforbusinessOnUpdatedFilesTriggerPayload&gt;(body)</c>.
/// </summary>
...
/// <summary>
/// Exception thrown when onedriveforbusiness connector operations fail.
/// </summary>
public class OnedriveforbusinessConnectorException : Exception
{
    ...
    public OnedriveforbusinessConnectorException(string operation, int statusCode, string responseBody)
...
/// </summary>
public class OnedriveforbusinessClient : IDisposable
{
    ...
    public OnedriveforbusinessClient(string connectionRuntimeUrl, TokenCredential credential = null, HttpClient httpClient = null)
    {
    ...
    /// <summary>
    /// Creates a new OnedriveforbusinessClient with managed identity support.
    /// </summary>
    /// <param name="connectionRuntimeUrl">The connection runtime URL from Azure Portal.</param>
    ...
    /// <param name="httpClient">Optional <see cref="HttpClient"/>. A new one will be created if not provided.</param>
    public OnedriveforbusinessClient(string connectionRuntimeUrl, string managedIdentityClientId, HttpClient httpClient = null)
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!response.IsSuccessStatusCode)
        {
            ...
            throw new OnedriveforbusinessConnectorException(operation, (int)response.StatusCode, errorBody);
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            var responseBody = await response.Content.ReadAsStringAsync(cancellationToken);
            throw new OnedriveforbusinessConnectorException(operation, (int)response.StatusCode, responseBody);
        }
    }
