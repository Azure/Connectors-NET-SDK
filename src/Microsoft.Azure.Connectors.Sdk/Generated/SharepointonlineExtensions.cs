// SharepointonlineExtensions.cs - Auto-generated DirectClient SDK
...
namespace Microsoft.Azure.Connectors.DirectClient.Sharepointonline;
...
/// </summary>
public class SharepointonlineConnectorException : Exception
{
...
public class SharepointonlineClient : IDisposable
{
    ...
    /// <param name="httpClient">Optional <see cref="HttpClient"/>. A new one will be created if not provided.</param>
    public SharepointonlineClient(string connectionRuntimeUrl, string managedIdentityClientId, HttpClient httpClient = null)
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!response.IsSuccessStatusCode)
        {
            ...
            throw new SharepointonlineConnectorException(operation, (int)response.StatusCode, errorBody);
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            var responseBody = await response.Content.ReadAsStringAsync(cancellationToken);
            throw new SharepointonlineConnectorException(operation, (int)response.StatusCode, responseBody);
        }
    }
