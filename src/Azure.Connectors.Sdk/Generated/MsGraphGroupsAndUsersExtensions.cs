...
// NOTE(daviburg): This connector cannot be regenerated because the ARM API
// export for msgraphgroupsandusers returns no swagger. The List<object> →
// List<JsonElement?> migration was applied as a surgical hand-edit to maintain
// consistency with all other regenerated connectors (#161). Once the ARM export
// is fixed, regenerate this connector normally and remove this note.
