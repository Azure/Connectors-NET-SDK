    ...
    public class FormstackFormsClient : ConnectorClientBase
    {
        ...
        public virtual async Task GetFormSchemaAsync(int formId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var path = $"/api/v2/form/{Uri.EscapeDataString(Convert.ToString(formId, CultureInfo.InvariantCulture))}/webhookopenapi/" + (queryParams.Count > 0 ? "?" + string.Join("&", queryParams) : "");
                await this
