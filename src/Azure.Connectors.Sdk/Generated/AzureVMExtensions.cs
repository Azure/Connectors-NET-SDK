...
namespace Azure.Connectors.Sdk.AzureVM
{
    ...
    public class AzureVMClient : ConnectorClientBase
    {
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups";
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachines";
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachineScaleSets";
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachineScaleSets/{Uri.EscapeDataString(virtualMachineScaleSet.ToString())}/virtualMachines";
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachineScaleSets/{Uri.EscapeDataString(virtualMachineScaleSet.ToString())}/virtualMachines/{Uri.EscapeDataString(virtualMachineInAVMScaleSet.ToString())}";
            return await this
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachineScaleSets/{Uri.EscapeDataString(virtualMachineScaleSet.ToString())}/virtualMachines/{Uri.EscapeDataString(virtualMachineInAVMScaleSet.ToString())}/deallocate";
            await this
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachineScaleSets/{Uri.EscapeDataString(virtualMachineScaleSet.ToString())}/virtualMachines/{Uri.EscapeDataString(virtualMachineInAVMScaleSet.ToString())}/redeploy";
            await this
                .CallConnectorAsync(HttpMethod.Post, path, cancellationToken: cancellationToken)
                .ConfigureAwait(continueOnCapturedContext: false);
        }
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachineScaleSets/{Uri.EscapeDataString(virtualMachineScaleSet.ToString())}/virtualMachines/{Uri.EscapeDataString(virtualMachineInAVMScaleSet.ToString())}/reimage";
            await this
                .CallConnectorAsync(HttpMethod.Post, path, cancellationToken: cancellationToken)
                .ConfigureAwait(continueOnCapturedContext: false);
        }
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachineScaleSets/{Uri.EscapeDataString(virtualMachineScaleSet.ToString())}/virtualMachines/{Uri.EscapeDataString(virtualMachineInAVMScaleSet.ToString())}/restart";
            await this
                .CallConnectorAsync(HttpMethod.Post, path, cancellationToken: cancellationToken)
                .ConfigureAwait(continueOnCapturedContext: false);
        }
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachineScaleSets/{Uri.EscapeDataString(virtualMachineScaleSet.ToString())}/virtualMachines/{Uri.EscapeDataString(virtualMachineInAVMScaleSet.ToString())}/start";
            await this
                .CallConnectorAsync(HttpMethod.Post, path, cancellationToken: cancellationToken)
                .ConfigureAwait(continueOnCapturedContext: false);
        }
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachines/{Uri.EscapeDataString(virtualMachine.ToString())}";
            return await this
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachines/{Uri.EscapeDataString(virtualMachine.ToString())}/start";
            await this
                .CallConnectorAsync(HttpMethod.Post, path, cancellationToken: cancellationToken)
                .ConfigureAwait(continueOnCapturedContext: false);
        }
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachines/{Uri.EscapeDataString(virtualMachine.ToString())}/deallocate";
            await this
                .CallConnectorAsync(HttpMethod.Post, path, cancellationToken: cancellationToken)
                .ConfigureAwait(continueOnCapturedContext: false);
        }
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachines/{Uri.EscapeDataString(virtualMachine.ToString())}/powerOff";
            await this
                .CallConnectorAsync(HttpMethod.Post, path, cancellationToken: cancellationToken)
                .ConfigureAwait(continueOnCapturedContext: false);
        }
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachines/{Uri.EscapeDataString(virtualMachine.ToString())}/reapply";
            await this
                .CallConnectorAsync(HttpMethod.Post, path, cancellationToken: cancellationToken)
                .ConfigureAwait(continueOnCapturedContext: false);
        }
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachines/{Uri.EscapeDataString(virtualMachine.ToString())}/redeploy";
            await this
                .CallConnectorAsync(HttpMethod.Post, path, cancellationToken: cancellationToken)
                .ConfigureAwait(continueOnCapturedContext: false);
        }
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscriptionId.ToString())}/resourcegroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Compute/virtualMachines/{Uri.EscapeDataString(virtualMachine.ToString())}/restart";
            await this
                .CallConnectorAsync(HttpMethod.Post, path, cancellationToken: cancellationToken)
                .ConfigureAwait(continueOnCapturedContext: false);
        }
