...
namespace Azure.Connectors.Sdk.AzureAutomation
{
    ...
    public class AzureAutomationClient : ConnectorClientBase
    {
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscription.ToString())}/resourcegroups";
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscription.ToString())}/resourceGroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Automation/automationAccounts";
            return await this
        ...
        {
            var path = $"/subscriptions/{Uri.EscapeDataString(subscription.ToString())}/resourceGroups/{Uri.EscapeDataString(resourceGroup.ToString())}/providers/Microsoft.Automation/automationAccounts/{Uri.EscapeDataString(automationAccount.ToString())}/runbooks";
            return await this
