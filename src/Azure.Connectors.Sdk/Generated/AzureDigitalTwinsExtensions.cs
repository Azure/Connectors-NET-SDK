...
namespace Azure.Connectors.Sdk.AzureDigitalTwins
{
    ...
    public class AzureDigitalTwinsClient : ConnectorClientBase
    {
        ...
        {
            var path = $"/models/{Uri.EscapeDataString(modelId.ToString())}";
            await this
        ...
        {
            var path = $"/digitaltwins/{Uri.EscapeDataString(digitalTwinId.ToString())}";
            return await this
        ...
        {
            var path = $"/digitaltwins/{Uri.EscapeDataString(digitalTwinId.ToString())}/components/{Uri.EscapeDataString(dTDLComponent.ToString())}";
            return await this
        ...
        {
            var path = $"/digitaltwins/{Uri.EscapeDataString(digitalTwinId.ToString())}/relationships/{Uri.EscapeDataString(relationshipId.ToString())}";
            return await this
        ...
        {
            var path = $"/digitaltwins/{Uri.EscapeDataString(digitalTwinId.ToString())}/telemetry";
            await this
        ...
        {
            var path = $"/digitaltwins/{Uri.EscapeDataString(digitalTwinId.ToString())}/components/{Uri.EscapeDataString(dTDLComponent.ToString())}/telemetry";
            await this
                .CallConnectorAsync(HttpMethod.Post, path, input, cancellationToken)
                .ConfigureAwait(continueOnCapturedContext: false);
        }
