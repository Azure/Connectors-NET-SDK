    ...
    public class WordPressClient : ConnectorClientBase
    {
        ...
        public virtual async Task<SiteStatsModel> SiteStatsAsync([DynamicValues("ListSites")] string siteId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var path = $"/sites/{Uri.EscapeDataString(System.Convert.ToString(siteId, System.Globalization.CultureInfo.InvariantCulture))}/stats" + (queryParams.Count > 0 ? "?" + string.Join("&", queryParams) : "");
                return await this
        ...
        public virtual async Task<PostModel> GetAsync([DynamicValues("ListSites")] string siteId, string postId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var path = $"/sites/{Uri.EscapeDataString(System.Convert.ToString(siteId, System.Globalization.CultureInfo.InvariantCulture))}/posts/{Uri.EscapeDataString(System.Convert.ToString(postId, System.Globalization.CultureInfo.InvariantCulture))}";
                return await this
        ...
        public virtual async Task<PostModel> CreateAsync([DynamicValues("ListSites")] string siteId, CreatePostModel input, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (siteId is null)
                    throw new ArgumentNullException(nameof(siteId));
                var path = $"/sites/{Uri.EscapeDataString(System.Convert.ToString(siteId, System.Globalization.CultureInfo.InvariantCulture))}/posts/new";
                return await this
