...
namespace Azure.Connectors.Sdk.Tests
{
    ...
    public class PlannerClientTests
    {
        ...
        {
            using var client = new PlannerClient("https://test.azure.com/conn");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new PlannerClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new PlannerClient("https://test.azure.com/conn");
            client.Dispose();
        }
        ...
        {
            var client = new PlannerClient(new Uri("https://test.azure.com/conn"), SharedMockCredential.Object);
            client.Dispose();
            client.Dispose();
        }

        private static PlannerClient CreateMockedClient(HttpResponseMessage response)
        {
            ...
            return new PlannerClient(new Uri("https://test.azure.com/conn"), SharedMockCredential.Object, options);
        }
