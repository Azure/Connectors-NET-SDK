...
namespace Azure.Connectors.Sdk.Tests
{
    ...
    public class FtpClientTests
    {
        ...
        private static FtpClient CreateMockedClient(HttpResponseMessage response)
        {
        ...
        {
            using var client = new FtpClient("https://test.azure.com/connection");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new FtpClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new FtpClient("https://test.azure.com/connection");
            client.Dispose();
        }
        ...
        [TestMethod]
        public async Task CreateFileAsync_WithMockedResponse_ReturnsExpected()
        {
            ...
            var result = await client
                .CreateFileAsync(input: Array.Empty<byte>(),
                    folderPath: "/test",
                    fileName: "file.txt",
        ...
        [TestMethod]
        public async Task CreateFileAsync_WithErrorResponse_ThrowsConnectorException()
        {
            using var responseMessage = new HttpResponseMessage
            {
            ...
            await Assert.ThrowsExactlyAsync<ConnectorException>(() =>
                client.CreateFileAsync(input: Array.Empty<byte>(),
                    folderPath: "/test",
                    fileName: "file.txt",
                    cancellationToken: CancellationToken.None))
                .ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task ListFolderAsync_WithMockedResponse_ReturnsExpected()
        {
            ...
            var result = await client
                .ListFolderAsync(folder: "folder1",
                    cancellationToken: CancellationToken.None)
                .ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task ListFolderAsync_WithErrorResponse_ThrowsConnectorException()
        {
            ...
            await Assert.ThrowsExactlyAsync<ConnectorException>(() =>
                client.ListFolderAsync(folder: "folder1",
                    cancellationToken: CancellationToken.None))
                .ConfigureAwait(continueOnCapturedContext: false);
        }
