...
namespace Azure.Connectors.Sdk.Tests
{
    ...
    public class TwitterClientTests
    {
        ...
        private static TwitterClient CreateMockedClient(HttpResponseMessage response)
        {
        ...
        {
            using var client = new TwitterClient("https://test.azure.com/connection");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new TwitterClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new TwitterClient("https://test.azure.com/connection");
            client.Dispose();
        }
        ...
        [TestMethod]
        public async Task UserAsync_WithMockedResponse_ReturnsExpected()
        {
        ...
        [TestMethod]
        public async Task UserAsync_WithErrorResponse_ThrowsConnectorException()
        {
            using var responseMessage = new HttpResponseMessage
            {
            ...
            await Assert.ThrowsExactlyAsync<ConnectorException>(() =>
                client.UserAsync(userName: "user1",
                    cancellationToken: CancellationToken.None))
                .ConfigureAwait(continueOnCapturedContext: false);
        }
