...
namespace Azure.Connectors.Sdk.Tests
{
    ...
    public class BoxClientTests
    {
        ...
        private static BoxClient CreateMockedClient(HttpResponseMessage response)
        {
        ...
        {
            using var client = new BoxClient("https://test.azure.com/connection");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new BoxClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new BoxClient("https://test.azure.com/connection");
            client.Dispose();
        }
        ...
        public async Task GetFileMetadataAsync_WithMockedResponse_ReturnsExpected()
        {
            ...
            var result = await client
                .GetFileMetadataAsync(fileId: "file1",
        ...
        public async Task GetFileMetadataAsync_WithErrorResponse_ThrowsConnectorException()
        {
            ...
            await Assert.ThrowsExactlyAsync<ConnectorException>(() =>
                client.GetFileMetadataAsync(fileId: "file1",
                    cancellationToken: CancellationToken.None))
                .ConfigureAwait(continueOnCapturedContext: false);
        }
