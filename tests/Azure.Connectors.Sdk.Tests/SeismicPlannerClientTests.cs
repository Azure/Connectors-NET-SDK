...
{
    [TestClass]
    public class SeismicPlannerClientTests
    {
        ...
        private static SeismicPlannerClient CreateMockedClient(HttpResponseMessage response)
        {
            ...
            return new SeismicPlannerClient(new Uri("https://test.azure.com/conn"), SharedMockCredential.Object, options);
        }

        [TestMethod]
        public void Constructor_WithValidUrl_ShouldCreateInstance()
        {
            using var client = new SeismicPlannerClient("https://test.azure.com/conn");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new SeismicPlannerClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new SeismicPlannerClient("https://test.azure.com/conn");
            client.Dispose();
        }
        ...
        [TestMethod]
        public async Task GetCommentsAsync_WithErrorResponse_ThrowsConnectorException()
        {
