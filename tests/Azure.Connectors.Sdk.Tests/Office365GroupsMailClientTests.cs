...
{
    [TestClass]
    public class Office365GroupsMailClientTests
    {
        ...
        {
            using var client = new Office365GroupsMailClient("https://test.azure.com/conn");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new Office365GroupsMailClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new Office365GroupsMailClient("https://test.azure.com/conn");
            client.Dispose();
        }
        ...
        {
            var client = new Office365GroupsMailClient(new Uri("https://test.azure.com/conn"), SharedMockCredential.Object);
            client.Dispose();
            client.Dispose();
        }
    }
