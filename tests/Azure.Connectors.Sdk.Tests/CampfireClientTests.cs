...
{
    [TestClass]
    public class CampfireClientTests
    {
        ...
        private static CampfireClient CreateMockedClient(HttpResponseMessage response)
        {
        ...
        {
            using var client = new CampfireClient("https://test.azure.com/connection");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new CampfireClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new CampfireClient("https://test.azure.com/connection");
            client.Dispose();
        }
        ...
        [TestMethod]
        public async Task CreateMessageAsync_WithMockedResponse_ReturnsExpected()
        {
        ...
        [TestMethod]
        public async Task CreateMessageAsync_WithErrorResponse_ThrowsConnectorException()
        {
            using var responseMessage = new HttpResponseMessage
            {
