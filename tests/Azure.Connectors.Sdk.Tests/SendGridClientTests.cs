...
namespace Azure.Connectors.Sdk.Tests
{
    ...
    public class SendGridClientTests
    {
        ...
        private static SendGridClient CreateMockedClient(HttpResponseMessage response)
        {
        ...
        {
            using var client = new SendGridClient("https://test.azure.com/connection");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new SendGridClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new SendGridClient("https://test.azure.com/connection");
            client.Dispose();
        }
        ...
        [TestMethod]
        public async Task GetGlobalSuppressionAsync_WithMockedResponse_ReturnsExpected()
        {
            ...
            var result = await client
                .GetGlobalSuppressionAsync(email: "test@test.com",
        ...
        [TestMethod]
        public async Task GetGlobalSuppressionAsync_WithErrorResponse_ThrowsConnectorException()
        {
            using var responseMessage = new HttpResponseMessage
            {
            ...
            await Assert.ThrowsExactlyAsync<ConnectorException>(() =>
                client.GetGlobalSuppressionAsync(email: "test@test.com",
                    cancellationToken: CancellationToken.None))
                .ConfigureAwait(continueOnCapturedContext: false);
        }
