...
{
    [TestClass]
    public class ZohoSignClientTests
    {
        ...
        private static ZohoSignClient CreateMockedClient(HttpResponseMessage response)
        {
        ...
        {
            using var client = new ZohoSignClient("https://test.azure.com/connection");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new ZohoSignClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new ZohoSignClient("https://test.azure.com/connection");
            client.Dispose();
        }
        ...
        [TestMethod]
        public async Task InvokeAPIAsync_WithMockedResponse_ReturnsExpected()
        {
        ...
        [TestMethod]
        public async Task InvokeAPIAsync_WithErrorResponse_ThrowsConnectorException()
        {
            using var responseMessage = new HttpResponseMessage
            {
