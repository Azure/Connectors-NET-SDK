...
{
    [TestClass]
    public class RepliconClientTests
    {
        ...
        private static RepliconClient CreateMockedClient(HttpResponseMessage response)
        {
        ...
        {
            using var client = new RepliconClient("https://test.azure.com/connection");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new RepliconClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new RepliconClient("https://test.azure.com/connection");
            client.Dispose();
        }
        ...
        [TestMethod]
        public async Task BulkGetProjectDetails3Async_WithMockedResponse_ReturnsExpected()
        {
        ...
        [TestMethod]
        public async Task BulkGetProjectDetails3Async_WithErrorResponse_ThrowsConnectorException()
        {
            using var responseMessage = new HttpResponseMessage
            {
