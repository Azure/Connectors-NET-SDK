...
namespace Azure.Connectors.Sdk.Tests
{
    ...
    public class WebexClientTests
    {
        ...
        private static WebexClient CreateMockedClient(HttpResponseMessage response)
        {
        ...
        {
            using var client = new WebexClient("https://test.azure.com/connection");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new WebexClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new WebexClient("https://test.azure.com/connection");
            client.Dispose();
        }
        ...
        [TestMethod]
        public async Task GetMessagesAsync_WithMockedResponse_ReturnsExpected()
        {
        ...
        [TestMethod]
        public async Task GetMessagesAsync_WithErrorResponse_ThrowsConnectorException()
        {
            using var responseMessage = new HttpResponseMessage
            {
            ...
            await Assert.ThrowsExactlyAsync<ConnectorException>(() =>
                client.GetMessagesAsync(space: "space1",
                    cancellationToken: CancellationToken.None))
                .ConfigureAwait(continueOnCapturedContext: false);
        }
