...
namespace Azure.Connectors.Sdk.Tests
{
    ...
    public class DropboxClientTests
    {
        ...
        private static DropboxClient CreateMockedClient(HttpResponseMessage response)
        {
        ...
        {
            using var client = new DropboxClient("https://test.azure.com/connection");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new DropboxClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new DropboxClient("https://test.azure.com/connection");
            client.Dispose();
        }
