...
{
    [TestClass]
    public class TextRequestClientTests
    {
        ...
        private static TextRequestClient CreateMockedClient(HttpResponseMessage response)
        {
            ...
            return new TextRequestClient(new Uri("https://test.azure.com/conn"), SharedMockCredential.Object, options);
        }

        [TestMethod]
        public void Constructor_WithValidUrl_ShouldCreateInstance()
        {
            using var client = new TextRequestClient("https://test.azure.com/conn");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new TextRequestClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new TextRequestClient("https://test.azure.com/conn");
            client.Dispose();
        }
        ...
        {
            var client = new TextRequestClient(new Uri("https://test.azure.com/conn"), SharedMockCredential.Object);
            client.Dispose();
            client.Dispose();
        }

        [TestMethod]
        public async Task GetMessagesByContactPhoneAsync_WithErrorResponse_ThrowsConnectorException()
        {
