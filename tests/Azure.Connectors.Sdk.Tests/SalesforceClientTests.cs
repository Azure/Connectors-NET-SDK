...
namespace Azure.Connectors.Sdk.Tests
{
    ...
    public class SalesforceClientTests
    {
        ...
        private static SalesforceClient CreateMockedClient(HttpResponseMessage response)
        {
        ...
        {
            using var client = new SalesforceClient("https://test.azure.com/connection");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new SalesforceClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new SalesforceClient("https://test.azure.com/connection");
            client.Dispose();
        }
        ...
        [TestMethod]
        public async Task GetTableAsync_WithMockedResponse_ReturnsExpected()
        {
            ...
            var result = await client
                .GetTableAsync(salesforceObjectType: "Account",
        ...
        public async Task GetTableAsync_WithErrorResponse_ThrowsConnectorException()
        {
            ...
            await Assert.ThrowsExactlyAsync<ConnectorException>(() =>
                client.GetTableAsync(salesforceObjectType: "Account",
                    cancellationToken: CancellationToken.None))
                .ConfigureAwait(continueOnCapturedContext: false);
        }
