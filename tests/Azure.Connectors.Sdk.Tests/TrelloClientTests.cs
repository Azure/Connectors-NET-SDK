...
namespace Azure.Connectors.Sdk.Tests
{
    ...
    public class TrelloClientTests
    {
        ...
        private static TrelloClient CreateMockedClient(HttpResponseMessage response)
        {
        ...
        {
            using var client = new TrelloClient("https://test.azure.com/connection");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new TrelloClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new TrelloClient("https://test.azure.com/connection");
            client.Dispose();
        }
        ...
        [TestMethod]
        public async Task GetCardAsync_WithMockedResponse_ReturnsExpected()
        {
        ...
        [TestMethod]
        public async Task GetCardAsync_WithErrorResponse_ThrowsConnectorException()
        {
            using var responseMessage = new HttpResponseMessage
            {
            ...
            await Assert.ThrowsExactlyAsync<ConnectorException>(() =>
                client.GetCardAsync(cardId: "card1",
                    boardId: "board1",
                    cancellationToken: CancellationToken.None))
                .ConfigureAwait(continueOnCapturedContext: false);
        }
