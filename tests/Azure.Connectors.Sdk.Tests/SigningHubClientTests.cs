...
{
    [TestClass]
    public class SigningHubClientTests
    {
        ...
        {
            using var client = new SigningHubClient("https://test.azure.com/connection");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new SigningHubClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new SigningHubClient("https://test.azure.com/connection");
            client.Dispose();
        }
        ...
        {
            var client = new SigningHubClient(
                connectionRuntimeUrl: new Uri("https://test.azure.com/connection"),
                credential: SharedMockCredential.Object);
            client.Dispose();
            client.Dispose();
