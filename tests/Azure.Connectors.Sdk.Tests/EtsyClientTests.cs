...
namespace Azure.Connectors.Sdk.Tests
{
    ...
    public class EtsyClientTests
    {
        ...
        private static EtsyClient CreateMockedClient(HttpResponseMessage response)
        {
        ...
        {
            using var client = new EtsyClient("https://test.azure.com/connection");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new EtsyClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new EtsyClient("https://test.azure.com/connection");
            client.Dispose();
        }
        ...
        [TestMethod]
        public async Task PingAsync_WithMockedResponse_ReturnsExpected()
        {
            ...
            var result = await client
                .PingAsync(cancellationToken: CancellationToken.None)
        ...
        [TestMethod]
        public async Task PingAsync_WithErrorResponse_ThrowsConnectorException()
        {
            using var responseMessage = new HttpResponseMessage
            {
            ...
            await Assert.ThrowsExactlyAsync<ConnectorException>(() =>
                client.PingAsync(cancellationToken: CancellationToken.None))
                .ConfigureAwait(continueOnCapturedContext: false);
        }
