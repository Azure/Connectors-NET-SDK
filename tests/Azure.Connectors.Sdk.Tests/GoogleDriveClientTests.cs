...
namespace Azure.Connectors.Sdk.Tests
{
    ...
    public class GoogleDriveClientTests
    {
        ...
        private static GoogleDriveClient CreateMockedClient(HttpResponseMessage response)
        {
        ...
        {
            using var client = new GoogleDriveClient("https://test.azure.com/connection");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new GoogleDriveClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new GoogleDriveClient("https://test.azure.com/connection");
            client.Dispose();
        }
