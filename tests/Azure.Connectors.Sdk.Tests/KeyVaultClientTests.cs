...
namespace Azure.Connectors.Sdk.Tests
{
    ...
    public class KeyVaultClientTests
    {
        ...
        {
            using var client = new KeyVaultClient("https://test.azure.com/conn");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new KeyVaultClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new KeyVaultClient("https://test.azure.com/conn");
            client.Dispose();
        }
        ...
        {
            var client = new KeyVaultClient(new Uri("https://test.azure.com/conn"), SharedMockCredential.Object);
            client.Dispose();
            client.Dispose();
        }

        private static KeyVaultClient CreateMockedClient(HttpResponseMessage response)
        {
            ...
            return new KeyVaultClient(new Uri("https://test.azure.com/conn"), SharedMockCredential.Object, options);
        }

        [TestMethod]
        public async Task ListKeysAsync_WithErrorResponse_ThrowsConnectorException()
        {
