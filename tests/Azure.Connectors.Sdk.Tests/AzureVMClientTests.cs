...
{
    [TestClass]
    public class AzureVMClientTests
    {
        ...
        {
            using var client = new AzureVMClient("https://test.azure.com/conn");
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new AzureVMClient((string)null!));
        }

        [TestMethod]
        public void Dispose_ShouldNotThrow()
        {
            var client = new AzureVMClient("https://test.azure.com/conn");
            client.Dispose();
        }
        ...
        {
            var client = new AzureVMClient(new Uri("https://test.azure.com/conn"), SharedMockCredential.Object);
            client.Dispose();
            client.Dispose();
        }
