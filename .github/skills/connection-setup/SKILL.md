...
Supported SDK connector names: `arm`, `azureblob`, `azureeventgrid`, `azuremonitorlogs`, `campfire`, `clicksendsms`, `cloudmersiveconvert`, `etsy`, `excelonline`, `formstackforms`, `freshservice`, `infusionsoft`, `insightly`, `kusto`, `mq`, `msgraphgroupsanduser`, `office365`, `office365users`, `onedriveforbusiness`, `pipedrive`, `plivo`, `plumsail`, `replicon`, `revai`, `sharepointonline`, `signinghub`, `smtp`, `teams`, `universalprint`, `wdatp`, `yammer`, `zohosign` (and any `Microsoft.Web/connections` connector name).
