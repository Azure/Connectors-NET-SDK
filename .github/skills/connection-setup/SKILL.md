...
Supported SDK connector names: `azureloganalytics`, `office365`, `office365users`, `onedriveforbusiness`, `sharepointonline`, `teams`, `msgraphgroupsanduser` (and any `Microsoft.Web/connections` connector name).
